...
namespace FrancisMod.Common.Systems
{
	// Acts as a container for "downed boss" flags.
	// Set a flag like this in your bosses OnKill hook:
	//    NPC.SetEventFlagCleared(ref DownedBossSystem.downedMGFrancis, -1);
	...
	{
		public static bool downedMGFrancis = false;
		// public static bool downedOtherBoss = false;

		public override void ClearWorld() {
			downedMGFrancis = false;
		...
		public override void SaveWorldData(TagCompound tag) {
			if (downedMGFrancis) {
				tag["downedMGFrancis"] = true;
			}
		}

		public override void LoadWorldData(TagCompound tag) {
			downedMGFrancis = tag.ContainsKey("downedMGFrancis");
		...
		public override void NetSend(BinaryWriter writer) {
			...
			*/
			...
			// BitsByte flags = new BitsByte(downedMGFrancis, downedOtherBoss);
			// writer.Write(flags);
