...
namespace FrancisMod.Content.Tiles
{
	...
	public class MGFrancisRelic : ModTile
	{
		...
		public virtual string RelicTextureName => "FrancisMod/Content/Tiles/MGFrancisRelic";

		// All relics use the same pedestal texture, this one is copied from vanilla
		public override string Texture => "FrancisMod/Content/Tiles/RelicPedestal";
