...
using FrancisMod.Content.NPCs.Bosses.FrancisTheGodOfSkinnyPop;
...
namespace FrancisMod.Content.Items.Consumables
{
	...
	public class DivineEggBiscuit : ModItem
	{
		...
		public override bool CanUseItem(Player player) {
			...
			return !NPC.AnyNPCs(ModContent.NPCType<FrancisTheGodOfSkinnyPop>());
		}
		...
		public override bool? UseItem(Player player) {
			if (player.whoAmI == Main.myPlayer) {
				...
				int type = ModContent.NPCType<FrancisTheGodOfSkinnyPop>();
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<RefinedFrancisBar>(3)
