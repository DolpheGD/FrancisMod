...
{
	public class SkinnyPop : ModItem
	{
		...
		public override void OnConsumeItem(Player player) {
			player.AddBuff(ModContent.BuffType<Buffs.SkinnyPopped>(), 36000);
		}
		...
		public override void AddRecipes() {
			CreateRecipe()
				.AddIngredient<FrancisDust>(2)
                .AddIngredient(ItemID.PotatoChips, 1)
